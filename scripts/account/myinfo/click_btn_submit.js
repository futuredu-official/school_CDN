async function click_btn_submit() {
	if (!toggle_signup_btn_submit) {
		...
		// Spinner
		ReactDOM.render(<Div_btn_submit_spinner class={class_btn_enabled + " cursor-not-allowed"} function={null} text={"정보 수정"} />, document.getElementById("btn_submit"))
		...
		inputData.append('uuid_join_service', uuid_join_service);
